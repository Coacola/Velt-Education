...
export function Topbar({ sidebarCollapsed, onMenuToggle }: TopbarProps) {
  ...
  return (
    <div
      className="fixed top-0 right-0 z-20 flex items-center gap-3 px-5 h-14"
      style={{
    ...
    >
      ...
      {/* View Switcher */}
      <div className="hidden md:flex items-center bg-white/5 border border-white/8 rounded-xl p-0.5">
        ...
        <AnimatePresence>
          {notifOpen && (
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 w-80 rounded-2xl border border-white/10 shadow-[0_16px_40px_rgba(0,0,0,0.5)] overflow-hidden z-50"
